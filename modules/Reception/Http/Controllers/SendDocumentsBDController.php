...
class SendDocumentsBDController extends NovaController {
	
    protected $module_path='reception/newPolicy/sendPolicyBD';
    ...
    public function printGuia($process_ID,Request $request){
        try{
            $pup=ProcessSendDocumentsBD::findProcess($process_ID);
