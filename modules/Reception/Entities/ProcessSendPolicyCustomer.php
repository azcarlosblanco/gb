 ...
 */
class ProcessSendPolicyCustomer extends ProcessEntry
{
	use \App\UploadAndDownloadFile;

	function __construct(){
		//call to method start of the 
		parent::__construct(array(),'SendPolicyCustomer');
	}

	public function doProcess(Request $request, $dataGuia){
		$policy=$this->procedureEntryRel->policy;
		$policy->state='wait_signed_policy';
		$policy->save();
		...
		$params['description_files'][]='guia_remision_to_customer';
