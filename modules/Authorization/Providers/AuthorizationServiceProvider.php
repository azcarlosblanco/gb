<?php namespace Modules\Authorization\Providers;
...
class AuthorizationServiceProvider extends ServiceProvider {
	...
	protected function registerConfig()
	{
		...
		$this->mergeConfigFrom(
		    __DIR__.'/../Config/config.php', 'authorization'
		);
	}
	...
	{
		$viewPath = base_path('resources/views/modules/authorization');
	...
	{
		$langPath = base_path('resources/lang/modules/authorization');
