		...
		<div class="col-lg-10">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					@if ($edit)
						<h3 class='m-t-none m-b'>{{ $plan->name }}</h3>
						@if ($edit)
							<a href="{{ route('plan_create_deducible') }}" 
					    		class="btn btn-primary">  
					    		<i class="fa fa-plus"></i>Create Deducibles
							</a>
						@endif
					@else
						<h3 class='m-t-none m-b'>Nuevo Plan</h3>
					@endif
				</div>
				<div class="ibox-content">
					...
					@endif
						<div class="form-group">
							...
							{!! Form::select(
								'insurance_company_id', $insuranceCompany, null, 
									['class' => 'form-control',
									$disabled=>$disabled]
							) !!}
						</div>
