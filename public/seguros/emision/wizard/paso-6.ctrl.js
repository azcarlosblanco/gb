angular
.module('ngNova')
.controller('WizPaso6Ctrl', ['response','Restangular','$scope', 'hotkeys', '$state', '$http', '__env', 'webNotification',
	...
	$scope.form = {}
	if(temp_data.eDatePrevInsurance_obj != undefined)
		$scope.form = temp_data.eDatePrevInsurance_obj;
	...
	$scope.next = function () {
		if ($scope.form) {
			...
			var	postUrl = "emission/newPolicy/uploadPolicyRequest/form/"+process_ID+"/step/6";
